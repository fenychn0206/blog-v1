...
为了保持文章质量，并保持互联网的开放共享精神，保持页面流量的稳定，综合考虑下本站的所有原创文章均采用cc协议中较宽松的[署名-非商业性使用-4.0 国际](https://creativecommons.org/licenses/by-nc-sa/4.0/deed.zh)标准。这篇文章主要想能够更加清楚明白的介绍本站的协议标准和要求。方便你合理的使用本站的文章。
...
关于主题样式的版权信息，可以详见[Redefine](https://redefine.ohevan.com)主题说明
